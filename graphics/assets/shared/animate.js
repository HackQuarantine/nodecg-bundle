...
function clock(do_show) {
    ...
    if (!do_show) {
        ...
        setTimeout(function() {
            elem2 = document.getElementsByClassName("clock-card")
...
var clock_html = '<span id="clock-d">00</span> DAYS, <span id="clock-h">00</span>:<span id="clock-m">00</span>:<span id="clock-s">00</span>'
